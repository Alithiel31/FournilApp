...
<style>
  ...
  .pills button.active { border-color: #c4771c; background: #fbf3e6; color: #26221c; }
  .carte { background: #fff; border: 1px solid #e5dfd2; border-radius: 16px; overflow: hidden; }
  .entete {
    padding: 13px 16px; border-bottom: 1px solid #e5dfd2;
    display: flex; justify-content: space-between; align-items: baseline;
  }
  .titre { font-family: Georgia, serif; font-size: 19px; font-weight: 700; }
  .meta { font-size: 12px; color: #8a8271; }
  .corps { padding: 6px 16px 14px; }
  .ligne {
    display: flex; justify-content: space-between;
    padding: 9px 0; border-bottom: 1px dashed #e5dfd2; font-size: 14px; font-weight: 600;
  }
  .num { font-family: 'Courier New', monospace; font-weight: 700; }
  .note { font-size: 12px; color: #8a8271; text-align: center; margin-top: 12px; }
</style>
